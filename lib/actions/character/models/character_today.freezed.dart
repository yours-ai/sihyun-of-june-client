...
CharacterToday _$CharacterTodayFromJson(Map<String, dynamic> json) {
  return _CharacterToday.fromJson(json);
}

/// @nodoc
mixin _$CharacterToday {
  ...
  @JsonKey(ignore: true)
  $CharacterTodayCopyWith<CharacterToday> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $CharacterTodayCopyWith<$Res> {
  factory $CharacterTodayCopyWith(
          CharacterToday value, $Res Function(CharacterToday) then) =
      _$CharacterTodayCopyWithImpl<$Res, CharacterToday>;
  @useResult
  $Res call(
      {String text,
      String weather,
...
/// @nodoc
class _$CharacterTodayCopyWithImpl<$Res, $Val extends CharacterToday>
    implements $CharacterTodayCopyWith<$Res> {
  _$CharacterTodayCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$CharacterTodayImplCopyWith<$Res>
    implements $CharacterTodayCopyWith<$Res> {
  factory _$$CharacterTodayImplCopyWith(_$CharacterTodayImpl value,
          $Res Function(_$CharacterTodayImpl) then) =
      __$$CharacterTodayImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {String text,
...
/// @nodoc
class __$$CharacterTodayImplCopyWithImpl<$Res>
    extends _$CharacterTodayCopyWithImpl<$Res, _$CharacterTodayImpl>
    implements _$$CharacterTodayImplCopyWith<$Res> {
  __$$CharacterTodayImplCopyWithImpl(
      _$CharacterTodayImpl _value, $Res Function(_$CharacterTodayImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$CharacterTodayImpl(
      text: null == text
          ? _value.text
          : text // ignore: cast_nullable_to_non_nullable
              as String,
...
/// @nodoc
@JsonSerializable()
class _$CharacterTodayImpl implements _CharacterToday {
  _$CharacterTodayImpl(
      {required this.text,
  ...
  factory _$CharacterTodayImpl.fromJson(Map<String, dynamic> json) =>
      _$$CharacterTodayImplFromJson(json);
  ...
  @override
  String toString() {
    return 'CharacterToday(text: $text, weather: $weather, next_mail_available_at: $next_mail_available_at, is_next_mail_last: $is_next_mail_last, is_last_mail: $is_last_mail, is_just_replied: $is_just_replied, mail: $mail)';
  }
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$CharacterTodayImplCopyWith<_$CharacterTodayImpl> get copyWith =>
      __$$CharacterTodayImplCopyWithImpl<_$CharacterTodayImpl>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$CharacterTodayImplToJson(
      this,
    );
  }
}

abstract class _CharacterToday implements CharacterToday {
  factory _CharacterToday(
      ...
      final MailInList? mail}) = _$CharacterTodayImpl;

  factory _CharacterToday.fromJson(Map<String, dynamic> json) =
      _$CharacterTodayImpl.fromJson;
